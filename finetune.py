...
import hydra
import sys
sys.path.insert(0, "/home/zhura/workspace/py_workspace/dit-policy/data4robotics/sim")
sys.path.insert(0, "/home/zhura/workspace/py_workspace/dit-policy/robosuite/robosuite/utils")


import data4robotics.sim
